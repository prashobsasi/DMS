	...
	<div class="login-container">
		...
		<div class="login-form">
			<div class="login-content">
				...
				<h4 style="font-weight:bold;color: white">Employee Registration</h4>
				<form method="post" role="form" id="loginForm" action="<?php echo base_url();?>login/login_validation">
					...
					<input id="txtAppId" class="form-control" placeholder="Member ID" />
					</div>	
					</div>
				</form>
			</div>
